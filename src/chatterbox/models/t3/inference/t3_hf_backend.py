...
class T3HuggingfaceBackend(LlamaPreTrainedModel, GenerationMixin):
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize a new instance of LlamaInferencer.
        Args:
        config: LlamaConfig object containing configuration settings.
        llama: LlamaModel object representing the language model.
        speech_enc: Speech encoding component.
        speech_head: Speech decoding head.
        latents_queue: Queue for storing latent states (optional).
        logits_queue: Queue for storing logits (optional).
        alignment_stream_analyzer: AlignmentStreamAnalyzer instance (optional).
        """
