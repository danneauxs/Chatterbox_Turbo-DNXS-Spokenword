...
class S3Tokenizer(S3TokenizerV2):
    ...
    def __init__(
        ...
        """Initializes a speech tokenizer with specified name and configuration.
        Args:
        name (str): The name of the tokenizer. Default is "speech_tokenizer_v2_25hz".
        config (ModelConfig): Configuration object for the tokenizer. Default is ModelConfig().
        Returns: None
        """
        super().__init__(name)
