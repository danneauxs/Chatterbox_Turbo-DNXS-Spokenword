...
def load_chunks(path):
    """Load data from a JSON file, filtering out metadata entries.
    Args:
    path (str): The path to the JSON file.
    Returns:
    dict or list: The loaded data, with metadata entries removed if present.
    """
...
def save_chunks(path, chunks):
    ...
    Args:
    path (str): The file path where the chunks will be saved.
