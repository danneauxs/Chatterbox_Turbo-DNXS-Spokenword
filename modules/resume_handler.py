...
def resume_book_from_chunk(start_chunk):
    ...
    def prompt_float(prompt, default):
        """Prompts the user to enter a floating-point number with an optional default value and returns it as a float.
        Args:
        prompt (str): The input prompt message.
        default (float): The default value if no input is provided.
        Returns:
        float: The entered or default floating-point number.
        """
